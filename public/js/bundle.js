...
function normalizeValue(value) {
  ...
  return _utils.default.isArray(value) ? value.map(normalizeValue) : String(value).replace(/[\r\n]+$/, '');
}
...
const VERSION = exports.VERSION = "1.14.0";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return _axios.default.patch('/api/v1/users/updateMe', form, {
            withCredentials: true
          });
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'update successfully!');
            window.setTimeout(function () {
        ...
        case 2:
          _context.p = 2;
          _t = _context.v;
          msg = (_t === null || _t === void 0 || (_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Something went wrong!';
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(currentPassword, newPassword, passwordConfirm) {
    var res, _err$response2, msg, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _axios.default.patch('/api/v1/users/updateMyPassword', {
        ...
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          msg = (_t2 === null || _t2 === void 0 || (_err$response2 = _t2.response) === null || _err$response2 === void 0 || (_err$response2 = _err$response2.data) === null || _err$response2 === void 0 ? void 0 : _err$response2.message) || 'Something went wrong!';
          (0, _alerts.showAlert)('error', msg);
        case 3:
...
var getStripe = function getStripe() {
  if (!stripePromise) {
    stripePromise = (0, _stripeJs.loadStripe)('pk_test_51TJDBxDAHdlz4p9tKxn6P5c0L6vtk2PbwDLtgQp9AeQnBnbJVH2jdVxGjoyzrwQKC7rOTIyhjmPhanrkyQLGfnnf00LPdLavj0');
  }
  return stripePromise;
};
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // Polyfill for older browsers to support modern JS features
...
// Select the user data update form
var userFormSettings = document.querySelector('.form-user-settings');

// If the form exists
if (userFormSettings) {
  userFormSettings.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updatePassword)(currentPassword, newPassword, passwordConfirm);
  });
}
